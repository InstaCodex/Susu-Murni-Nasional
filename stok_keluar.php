        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Stok Keluar</h1>
                    <!-- DataTales Example -->
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        $query = "SELECT fk.id_faktur_keluar, fk.no_faktur_keluar, fk.tanggal, b.nama_barang, dfk.id_detail, dfk.satuan, dfk.jumlah, dfk.harga, dfk.total_harga FROM faktur_keluar fk JOIN detail_faktur_keluar dfk ON fk.id_faktur_keluar = dfk.id_faktur_keluar JOIN barang b ON dfk.id_barang = b.id_barang ORDER BY fk.tanggal DESC";
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="editModalLabel">Edit Stok Keluar</h5>
                                                    ...
                                                    <form action="functions.php" method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="hidden" name="id_faktur_keluar" value="<?= $data['id_faktur_keluar']; ?>">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" name="edit_stok_keluar" class="btn btn-primary">Simpan Perubahan</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal fade" id="deleteModal<?= $data['id_detail']; ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="deleteModalLabel">Hapus Stok Keluar</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <form action="functions.php" method="post">
                                                        <div class="modal-body">
                                                            <input type="hidden" name="id_detail" value="<?= $data['id_detail']; ?>">
                                                            <input type="hidden" name="id_faktur_keluar" value="<?= $data['id_faktur_keluar']; ?>">
                                                            <p>Apakah Anda yakin ingin menghapus stok keluar ini?</p>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                                            <button type="submit" name="delete_stok_keluar" class="btn btn-danger">Hapus</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="functions.php" method="post">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="addnewprodukkeluar" class="btn btn-primary">Submit</button>
