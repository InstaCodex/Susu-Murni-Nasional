...
<head>
    ...
    <title>Rekap Faktur Keluar</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">Rekap Faktur Keluar</h1>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Laporan Faktur Keluar</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT 
                                                    f.no_faktur_keluar,
                                                    f.tanggal,
                                                    COUNT(dfk.id_detail) as total_barang_jasa,
                                                    SUM(dfk.total_harga) as total_harga,
                                                    p.nama_pengguna
                                                FROM faktur_keluar f
                                                JOIN detail_faktur_keluar dfk ON f.id_faktur_keluar = dfk.id_faktur_keluar
                                                JOIN pengguna p ON f.id_pengguna = p.id_pengguna
                                                GROUP BY f.id_faktur_keluar
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Tambah Rekap Faktur Keluar</h4>
                ...
                <form action="functions.php" method="post">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="addrekapkeluar" class="btn btn-primary">Submit</button>
